...
namespace MultiFakeAuth
{
    internal class Metadata : IAuthenticationAdapterMetadata
    {
        ...
        {
            get { return "MultiFakeAuth MFA Adapter"; }
        }
        ...
        public Dictionary<int, string> FriendlyNames
        {
            get
            {
                ...
                _friendlyNames.Add(new CultureInfo("en-us").LCID, "MultiFakeAuth NOT FOR PROD");
        ...
        public Dictionary<int, string> Descriptions
        {
            get
            {
                ...
                _descriptions.Add(new CultureInfo("en-us").LCID, "MultiFakeAuth NOT FOR PROD");
